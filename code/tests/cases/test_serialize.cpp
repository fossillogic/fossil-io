...
FOSSIL_TEST_SUITE(cpp_serialize_suite);
...
FOSSIL_TEST_CASE(cpp_test_io_serialize_f32) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST_CASE(cpp_test_io_serialize_f64) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST_CASE(cpp_test_io_deserialize_f32) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST_CASE(cpp_test_io_deserialize_f64) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST_CASE(cpp_test_serialize_class_f32) {
    fossil::io::Serialize serializer(1024);
    int result = serializer.serialize_f32(3.14f);
    ASSUME_ITS_EQUAL_I32(0, result);
}

FOSSIL_TEST_CASE(cpp_test_serialize_class_f64) {
    fossil::io::Serialize serializer(1024);
    int result = serializer.serialize_f64(3.141592653589793);
    ASSUME_ITS_EQUAL_I32(0, result);
}
...
FOSSIL_TEST_CASE(cpp_test_deserialize_class_f32) {
    fossil::io::Serialize serializer(1024);
    serializer.serialize_f32(3.14f);
    size_t offset = 0;
    float value;
    int result = serializer.deserialize_f32(&offset, &value);
    ASSUME_ITS_EQUAL_I32(0, result);
    ASSUME_ITS_EQUAL_FLOAT(3.14f, value);
}

FOSSIL_TEST_CASE(cpp_test_deserialize_class_f64) {
    fossil::io::Serialize serializer(1024);
    serializer.serialize_f64(3.141592653589793);
    size_t offset = 0;
    double value;
    int result = serializer.deserialize_f64(&offset, &value);
    ASSUME_ITS_EQUAL_I32(0, result);
    ASSUME_ITS_EQUAL_DOUBLE(3.141592653589793, value);
}
...
FOSSIL_TEST_GROUP(cpp_serialize_tests) {
    ...
    FOSSIL_TEST_ADD(cpp_serialize_suite, cpp_test_io_deserialize_f32);
    FOSSIL_TEST_ADD(cpp_serialize_suite, cpp_test_io_deserialize_f64);
    ...
    FOSSIL_TEST_ADD(cpp_serialize_suite, cpp_test_serialize_class_f32);
    FOSSIL_TEST_ADD(cpp_serialize_suite, cpp_test_serialize_class_f64);
    ...
    FOSSIL_TEST_ADD(cpp_serialize_suite, cpp_test_deserialize_class_f32);
    FOSSIL_TEST_ADD(cpp_serialize_suite, cpp_test_deserialize_class_f64);
