...
FOSSIL_TEST_CASE(c_test_stream_read_buffered) {
...
FOSSIL_TEST_CASE(c_test_stream_write_buffered) {
...
FOSSIL_TEST_CASE(c_test_stream_lock_and_unlock) {
...
FOSSIL_TEST_CASE(c_test_stream_check_permission) {
...
FOSSIL_TEST_CASE(c_test_stream_set_and_get_permissions) {
...
FOSSIL_TEST_CASE(c_test_stream_restrict_permissions) {
...
FOSSIL_TEST_CASE(c_test_stream_check_ownership) {
...
FOSSIL_TEST_CASE(c_test_stream_compare_permissions) {
...
FOSSIL_TEST_GROUP(c_file_tests) {
    ...
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_read_buffered);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_write_buffered);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_lock_and_unlock);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_get_type);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_check_permission);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_set_and_get_permissions);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_restrict_permissions);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_check_ownership);
    FOSSIL_TEST_ADD(c_stream_suite, c_test_stream_compare_permissions);
