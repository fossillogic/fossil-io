...
FOSSIL_TEST(c_test_soap_sanitize_basic)
{
    ...
    ASSUME_ITS_CSTR_CONTAINS(result, "hello");
    free(result);
}
...
FOSSIL_TEST(c_test_soap_analyze_grammar_style_formal)
{
    ...
    ASSUME_ITS_WITHIN_RANGE_U8(result.passive_voice_pct, 0, 100);
...
FOSSIL_TEST(c_test_soap_correct_grammar)
{
    ...
    ASSUME_NOT_CNULL(result);
    ASSUME_ITS_MORE_THAN_SIZE(strlen(result), 0);
    free(result);
}
...
FOSSIL_TEST(c_test_soap_readability_label_excellent)
{
    ...
    ASSUME_ITS_EQUAL_CSTR(label, "excellent");
}
...
FOSSIL_TEST(c_test_soap_readability_label_good)
{
    ...
    ASSUME_NOT_CNULL(label);
    ASSUME_ITS_EQUAL_CSTR(label, "good");
}
...
FOSSIL_TEST(c_test_soap_readability_label_fair)
{
    ...
    ASSUME_NOT_CNULL(label);
    ASSUME_ITS_EQUAL_CSTR(label, "fair");
}
...
FOSSIL_TEST(c_test_soap_detect_spam)
{
    ...
    ASSUME_ITS_WITHIN_RANGE_I32(result, 0, 1);
}
...
FOSSIL_TEST(c_test_soap_split_sentences)
{
    ...
    ASSUME_ITS_MORE_THAN_I32(count, 0);
    free(result);
}
...
{
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_sanitize_basic);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_sanitize_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_suggest);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_summarize_basic);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_summarize_single_sentence);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_summarize_empty);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_analyze_grammar_style_formal);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_analyze_grammar_style_emotional);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_analyze_grammar_style_neutral);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_correct_grammar);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_correct_grammar_contractions);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_correct_grammar_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_score_normal_text);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_score_very_short);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_score_with_newlines);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_score_excessive_punctuation);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_readability_label_excellent);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_readability_label_good);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_readability_label_fair);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_readability_label_poor);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_spam);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_clickbait);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_ragebait);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_marketing);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_technobabble);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_political);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_conspiracy);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_formal);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_casual);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_sarcasm);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_emotional);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_aggressive);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_brain_rot);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_snowflake);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_redundant);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_repeated_words);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_null_text);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_null_detector);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_detect_unknown_detector);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_normalize);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_normalize_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_capitalize_sentence_case);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_capitalize_title_case);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_capitalize_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_reflow);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_reflow_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_reflow_zero_width);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_declutter_camelcase);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_declutter_pascalcase);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_declutter_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_punctuate);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_punctuate_repeated);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_punctuate_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_rewrite_full);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_rewrite_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_format);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_format_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_process_comprehensive);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_process_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_split_sentences);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_split_words);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_split_null);
    FOSSIL_ADD_TEST(c_soap_suite, c_test_soap_split_empty);

    FOSSIL_ADD_SUITE(c_soap_suite);
}
