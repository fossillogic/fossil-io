...
FOSSIL_TEST_CASE(cpp_test_io_what_no_error) {
...
FOSSIL_TEST_CASE(cpp_test_io_what_csrf_attack) {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_invalid_argument) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_type_mismatch) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_invalid_operation) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_unknown) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_custom) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_internal) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_unknown_error_code) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_overflow_int) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_out_of_memory) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_memory_corruption) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_buffer_overflow) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_buffer_underflow) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_file_not_found) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_permission_denied) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_network_failure) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_timeout) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_unknown_host) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_connection_refused) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_csrf_attack) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_user_abort) {
    try {
...
FOSSIL_TEST_CASE(cpp_test_io_error_exception_database_connection_failed) {
    try {
