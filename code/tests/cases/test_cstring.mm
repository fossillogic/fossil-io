...
FOSSIL_TEARDOWN(objcpp_string_suite) {
    // Teardown code here
}
...
FOSSIL_TEST(objcpp_test_cstring_create_and_free) {
...
FOSSIL_TEST(objcpp_test_cstring_copy) {
    const char *init = "Hello, World!";
    cstring str = fossil_io_cstring_create(init);
...
FOSSIL_TEST(objcpp_test_cstring_concat) {
    const char *s1 = "Hello, ";
    const char *s2 = "World!";
...
FOSSIL_TEST(objcpp_test_cstring_trim) {
...
FOSSIL_TEST(objcpp_test_cstring_split) {
...
FOSSIL_TEST(objcpp_test_cstring_replace) {
    const char *str = "Hello, World!";
...
FOSSIL_TEST(objcpp_test_cstring_to_upper) {
    cstring str = fossil_io_cstring_create("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_to_lower) {
    cstring str = fossil_io_cstring_create("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_starts_with) {
    const char *str = "Hello, World!";
    const char *prefix = "Hello";
    ASSUME_ITS_TRUE(fossil_io_cstring_starts_with(str, prefix));
}

FOSSIL_TEST(objcpp_test_cstring_ends_with) {
    const char *str = "Hello, World!";
    const char *suffix = "World!";
    ASSUME_ITS_TRUE(fossil_io_cstring_ends_with(str, suffix));
}

FOSSIL_TEST(objcpp_test_cstring_substring) {
    const char *str = "Hello, World!";
...
FOSSIL_TEST(objcpp_test_cstring_reverse) {
    cstring str = fossil_io_cstring_create("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_contains) {
    const char *str = "Hello, World!";
    const char *substr = "World";
    ASSUME_ITS_TRUE(fossil_io_cstring_contains(str, substr));
}

FOSSIL_TEST(objcpp_test_cstring_repeat) {
...
FOSSIL_TEST(objcpp_test_cstring_strip) {
    const char *str = "!!!Hello, World!!!";
...
FOSSIL_TEST(objcpp_test_cstring_count) {
...
FOSSIL_TEST(objcpp_test_cstring_pad_left) {
    const char *str = "Hello";
...
FOSSIL_TEST(objcpp_test_cstring_pad_right) {
    const char *str = "Hello";
...
FOSSIL_TEST(objcpp_test_cstring_icmp) {
    const char *s1 = "Hello";
    const char *s2 = "hello";
    const char *s3 = "World";
    const char *s4 = "Hell";
...
FOSSIL_TEST(objcpp_test_cstring_icontains) {
    const char *str = "Hello, World!";
...
FOSSIL_TEST(objcpp_test_cstring_format) {
...
FOSSIL_TEST(objcpp_test_cstring_join) {
...
FOSSIL_TEST(objcpp_test_cstring_iequals) {
    const char *a = "Test";
    const char *b = "test";
    const char *c = "toast";
...
FOSSIL_TEST(objcpp_test_cstring_escape_json) {
...
FOSSIL_TEST(objcpp_test_cstring_unescape_json) {
...
FOSSIL_TEST(objcpp_test_cstring_normalize_spaces) {
    cstring str = fossil_io_cstring_create("   Hello   World   ");
...
FOSSIL_TEST(objcpp_test_cstring_strip_quotes) {
...
FOSSIL_TEST(objcpp_test_cstring_append) {
...
FOSSIL_TEST(objcpp_test_cstring_stream_create_and_free) {
...
FOSSIL_TEST(objcpp_test_cstring_stream_write_and_read) {
    fossil_io_cstring_stream *stream = fossil_io_cstring_stream_create(1024);
...
FOSSIL_TEST(objcpp_test_cstring_stream_multiple_writes) {
    fossil_io_cstring_stream *stream = fossil_io_cstring_stream_create(1024);
...
FOSSIL_TEST(objcpp_test_cstring_stream_empty_read) {
    fossil_io_cstring_stream *stream = fossil_io_cstring_stream_create(1024);
    ccstring result = fossil_io_cstring_stream_read(stream);
    ASSUME_NOT_CNULL(result);
...
FOSSIL_TEST(objcpp_test_cstring_class_concat) {
...
FOSSIL_TEST(objcpp_test_cstring_class_length) {
    fossil::io::CString str("Hello, World!");
    size_t length = str.length();
    ASSUME_ITS_EQUAL_SIZE(strlen("Hello, World!"), length);
}

FOSSIL_TEST(objcpp_test_cstring_class_compare) {
...
FOSSIL_TEST(objcpp_test_cstring_class_trim) {
    fossil::io::CString str("   Hello, World!   ");
    str.trim();
    ASSUME_ITS_EQUAL_CSTR("Hello, World!", str.str());
}

FOSSIL_TEST(objcpp_test_cstring_class_split) {
...
FOSSIL_TEST(objcpp_test_cstring_class_replace) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_to_upper) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_to_lower) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_starts_with) {
    fossil::io::CString str("Hello, World!");
    ASSUME_ITS_TRUE(str.starts_with("Hello"));
}

FOSSIL_TEST(objcpp_test_cstring_class_ends_with) {
    fossil::io::CString str("Hello, World!");
    ASSUME_ITS_TRUE(str.ends_with("World!"));
}

FOSSIL_TEST(objcpp_test_cstring_class_substring) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_reverse) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_contains) {
    fossil::io::CString str("Hello, World!");
    ASSUME_ITS_TRUE(str.contains("World"));
}

FOSSIL_TEST(objcpp_test_cstring_class_repeat) {
...
FOSSIL_TEST(objcpp_test_cstring_class_strip) {
    fossil::io::CString str("!!!Hello, World!!!");
...
FOSSIL_TEST(objcpp_test_cstring_class_count) {
    fossil::io::CString str("Hello, World! Hello, Fossil!");
    size_t count = str.count("Hello");
    ASSUME_ITS_EQUAL_SIZE(2, count);
}

FOSSIL_TEST(objcpp_test_cstring_class_pad_left) {
    fossil::io::CString str("Hello");
...
FOSSIL_TEST(objcpp_test_cstring_class_pad_right) {
    fossil::io::CString str("Hello");
...
FOSSIL_TEST(objcpp_test_cstring_stream_class_create_and_free) {
    fossil::io::CStringStream stream(1024);
    ASSUME_NOT_CNULL(stream.read().c_str());
}

FOSSIL_TEST(objcpp_test_cstring_stream_class_write_and_read) {
    fossil::io::CStringStream stream(1024);
...
FOSSIL_TEST(objcpp_test_cstring_stream_class_multiple_writes) {
    fossil::io::CStringStream stream(1024);
    stream.write("Hello, ");
    stream.write("World!");
    std::string result = stream.read();
...
FOSSIL_TEST(objcpp_test_cstring_stream_class_empty_read) {
    fossil::io::CStringStream stream(1024);
    std::string result = stream.read();
    ASSUME_ITS_EQUAL_CSTR("", result.c_str());
}

FOSSIL_TEST(objcpp_test_cstring_class_icontains) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_join) {
...
FOSSIL_TEST(objcpp_test_cstring_class_index_of) {
    fossil::io::CString str("Hello, World!");
    ASSUME_ITS_EQUAL_I32(7, str.index_of("World"));
    ASSUME_ITS_EQUAL_I32(-1, str.index_of("Fossil"));
}

FOSSIL_TEST(objcpp_test_cstring_class_equals) {
    fossil::io::CString str("Hello, World!");
    ASSUME_ITS_TRUE(str.equals("Hello, World!"));
    ASSUME_ITS_TRUE(!str.equals("hello, world!"));
}

FOSSIL_TEST(objcpp_test_cstring_class_iequals) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_escape_json) {
...
FOSSIL_TEST(objcpp_test_cstring_class_unescape_json) {
    fossil::io::CString str("He said: \\\"Hello, World!\\\"\\n");
...
FOSSIL_TEST(objcpp_test_cstring_class_normalize_spaces) {
...
FOSSIL_TEST(objcpp_test_cstring_class_strip_quotes) {
...
FOSSIL_TEST(objcpp_test_cstring_class_append) {
    fossil::io::CString str("Hello");
...
FOSSIL_TEST(objcpp_test_cstring_class_copy_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_dup_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_concat_safe) {
    std::string s1 = "Safe";
...
FOSSIL_TEST(objcpp_test_cstring_class_substring_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_reverse_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_contains_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_repeat_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_strip_safe) {
    fossil::io::CString str("!!!Safe!!!");
...
FOSSIL_TEST(objcpp_test_cstring_class_count_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_pad_left_safe) {
    fossil::io::CString str("Safe");
...
FOSSIL_TEST(objcpp_test_cstring_class_pad_right_safe) {
    fossil::io::CString str("Safe");
...
FOSSIL_TEST(objcpp_test_cstring_class_starts_with_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_ends_with_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_equals_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_iequals_safe) {
    fossil::io::CString str("SafeEquals");
...
FOSSIL_TEST(objcpp_test_cstring_class_icontains_safe) {
    fossil::io::CString str("SafeContainsTest");
...
FOSSIL_TEST(objcpp_test_cstring_class_strip_quotes_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_normalize_spaces_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_index_of_safe) {
...
FOSSIL_TEST(objcpp_test_cstring_class_silly) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_piglatin) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_leetspeak) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_mocking) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_rot13) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_shuffle) {
    fossil::io::CString str("Hello, World!");
...
FOSSIL_TEST(objcpp_test_cstring_class_upper_snake) {
...
FOSSIL_TEST(objcpp_test_cstring_number_from_words_basic) {
    int value = 0;
...
FOSSIL_TEST(objcpp_test_cstring_number_from_words_invalid) {
    int value = 0;
...
FOSSIL_TEST(objcpp_test_cstring_number_to_words_basic) {
    char buffer[128];
...
FOSSIL_TEST(objcpp_test_cstring_number_to_words_buffer_too_small) {
    char buffer[8];
    ASSUME_ITS_TRUE(fossil_io_cstring_number_to_words(123456, buffer, sizeof(buffer)) != 0);
}

FOSSIL_TEST(objcpp_test_cstring_class_number_from_words_and_to_words) {
...
FOSSIL_TEST(objcpp_test_cstring_class_number_from_words_exception) {
    using fossil::io::CString;
    bool thrown = false;
    try {
...
FOSSIL_TEST(objcpp_test_cstring_class_number_to_words_exception) {
    using fossil::io::CString;
    bool thrown = false;
    try {
...
FOSSIL_TEST_GROUP(objcpp_string_tests) {
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_create_and_free);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_copy);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_concat);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_length);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_compare);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_trim);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_split);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_replace);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_to_upper);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_to_lower);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_starts_with);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_ends_with);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_substring);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_reverse);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_contains);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_repeat);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_strip);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_count);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_pad_left);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_pad_right);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_icmp);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_icontains);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_format);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_join);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_index_of);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_equals);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_iequals);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_escape_json);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_unescape_json);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_normalize_spaces);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_strip_quotes);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_append);

    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_copy_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_dup_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_concat_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_substring_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_reverse_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_contains_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_repeat_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_strip_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_count_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_pad_left_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_pad_right_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_starts_with_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_ends_with_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_equals_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_iequals_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_icontains_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_strip_quotes_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_normalize_spaces_safe);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_index_of_safe);

    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_create_and_free);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_write_and_read);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_multiple_writes);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_empty_read);

    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_silly);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_piglatin);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_leetspeak);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_mocking);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_rot13);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_shuffle);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_upper_snake);

    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_create_and_free);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_copy);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_concat);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_length);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_compare);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_trim);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_split);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_replace);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_to_upper);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_to_lower);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_starts_with);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_ends_with);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_substring);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_reverse);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_contains);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_repeat);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_strip);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_count);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_pad_left);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_pad_right);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_icontains);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_join);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_index_of);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_equals);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_iequals);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_escape_json);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_unescape_json);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_normalize_spaces);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_strip_quotes);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_append);

    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_number_from_words_basic);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_number_from_words_invalid);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_number_to_words_basic);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_number_to_words_buffer_too_small);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_number_from_words_and_to_words);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_number_from_words_exception);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_class_number_to_words_exception);

    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_class_create_and_free);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_class_write_and_read);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_class_multiple_writes);
    FOSSIL_TEST_ADD(objcpp_string_suite, objcpp_test_cstring_stream_class_empty_read);

    FOSSIL_TEST_REGISTER(objcpp_string_suite);
}
