...
FOSSIL_SUITE(c_serialize_suite);
...
FOSSIL_TEST(c_test_io_serialize_create) {
...
FOSSIL_TEST(c_test_io_serialize_expand) {
    fossil_io_serialize_buffer_t buf;
...
FOSSIL_TEST(c_test_io_serialize_i8) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_i64) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_u8) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_u16) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_u32) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_u64) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_cstr) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_bool) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_i8) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_i16) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_i32) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_i64) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_u8) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_u16) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_u32) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_u64) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_cstr) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_deserialize_bool) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
...
FOSSIL_TEST(c_test_io_serialize_to_file) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
    fossil_io_serialize_cstr(&buf, "test string");
...
FOSSIL_TEST(c_test_io_deserialize_from_file) {
    fossil_io_serialize_buffer_t buf;
    fossil_io_serialize_create(&buf, 1024);
    fossil_io_serialize_cstr(&buf, "test string");
