...
FOSSIL_SUITE(objc_string_suite);

// Setup function for the test suite
FOSSIL_SETUP(objc_string_suite) {
    // Setup code here
}

// Teardown function for the test suite
FOSSIL_TEARDOWN(objc_string_suite) {
    // Teardown code here
}
...
FOSSIL_TEST(objc_test_cstring_create_and_free) {
...
FOSSIL_TEST(objc_test_cstring_copy) {
    const char *init = "Hello, World!";
    cstring str = fossil_io_cstring_create(init);
...
FOSSIL_TEST(objc_test_cstring_concat) {
    const char *s1 = "Hello, ";
    const char *s2 = "World!";
...
FOSSIL_TEST(objc_test_cstring_trim) {
...
FOSSIL_TEST(objc_test_cstring_split) {
...
FOSSIL_TEST(objc_test_cstring_replace) {
    const char *str = "Hello, World!";
...
FOSSIL_TEST(objc_test_cstring_to_upper) {
    cstring str = fossil_io_cstring_create("Hello, World!");
...
FOSSIL_TEST(objc_test_cstring_to_lower) {
    cstring str = fossil_io_cstring_create("Hello, World!");
...
FOSSIL_TEST(objc_test_cstring_starts_with) {
    const char *str = "Hello, World!";
    const char *prefix = "Hello";
    ASSUME_ITS_TRUE(fossil_io_cstring_starts_with(str, prefix));
}

FOSSIL_TEST(objc_test_cstring_ends_with) {
    const char *str = "Hello, World!";
    const char *suffix = "World!";
    ASSUME_ITS_TRUE(fossil_io_cstring_ends_with(str, suffix));
}

FOSSIL_TEST(objc_test_cstring_substring) {
    const char *str = "Hello, World!";
...
FOSSIL_TEST(objc_test_cstring_reverse) {
    cstring str = fossil_io_cstring_create("Hello, World!");
...
FOSSIL_TEST(objc_test_cstring_contains) {
    const char *str = "Hello, World!";
    const char *substr = "World";
    ASSUME_ITS_TRUE(fossil_io_cstring_contains(str, substr));
}

FOSSIL_TEST(objc_test_cstring_repeat) {
...
FOSSIL_TEST(objc_test_cstring_strip) {
    const char *str = "!!!Hello, World!!!";
...
FOSSIL_TEST(objc_test_cstring_count) {
...
FOSSIL_TEST(objc_test_cstring_pad_left) {
    const char *str = "Hello";
...
FOSSIL_TEST(objc_test_cstring_pad_right) {
    const char *str = "Hello";
...
FOSSIL_TEST(objc_test_cstring_stream_create_and_free) {
...
FOSSIL_TEST(objc_test_cstring_stream_write_and_read) {
    fossil_io_cstring_stream *stream = fossil_io_cstring_stream_create(1024);
...
FOSSIL_TEST(objc_test_cstring_stream_multiple_writes) {
    fossil_io_cstring_stream *stream = fossil_io_cstring_stream_create(1024);
...
FOSSIL_TEST(objc_test_cstring_stream_empty_read) {
    fossil_io_cstring_stream *stream = fossil_io_cstring_stream_create(1024);
    ccstring result = fossil_io_cstring_stream_read(stream);
    ASSUME_NOT_CNULL(result);
...
FOSSIL_TEST(objc_test_cstring_icmp) {
    const char *s1 = "Hello";
    const char *s2 = "hello";
    const char *s3 = "World";
    const char *s4 = NULL;
...
FOSSIL_TEST(objc_test_cstring_icontains) {
    const char *str = "Hello, World!";
...
FOSSIL_TEST(objc_test_cstring_format) {
...
FOSSIL_TEST(objc_test_cstring_join) {
...
FOSSIL_TEST(objc_test_cstring_iequals) {
    const char *a = "Test";
    const char *b = "test";
    const char *c = "toast";
...
FOSSIL_TEST(objc_test_cstring_escape_json) {
...
FOSSIL_TEST(objc_test_cstring_unescape_json) {
...
FOSSIL_TEST(objc_test_cstring_normalize_spaces) {
    cstring str = fossil_io_cstring_create("   Hello   World   ");
...
FOSSIL_TEST(objc_test_cstring_strip_quotes) {
...
FOSSIL_TEST(objc_test_cstring_append) {
...
FOSSIL_TEST(objc_test_cstring_create_safe_and_free_safe) {
    const char *init = "Hello, World!";
    size_t max_len = 20;
...
FOSSIL_TEST(objc_test_cstring_copy_safe_and_dup_safe) {
...
FOSSIL_TEST(objc_test_cstring_concat_safe) {
    const char *s1 = "Safe";
...
FOSSIL_TEST(objc_test_cstring_length_safe) {
...
FOSSIL_TEST(objc_test_cstring_compare_safe) {
    const char *s1 = "Safe";
    const char *s2 = "Safe";
...
FOSSIL_TEST(objc_test_cstring_append_safe) {
...
FOSSIL_TEST(objc_test_cstring_trim_safe) {
...
FOSSIL_TEST(objc_test_cstring_split_safe) {
...
FOSSIL_TEST(objc_test_cstring_replace_safe) {
...
FOSSIL_TEST(objc_test_cstring_to_upper_safe_and_to_lower_safe) {
...
FOSSIL_TEST(objc_test_cstring_format_safe) {
    size_t max_len = 32;
...
FOSSIL_TEST(objc_test_cstring_join_safe) {
...
FOSSIL_TEST(objc_test_cstring_escape_json_safe_and_unescape_json_safe) {
    size_t max_len = 64;
...
FOSSIL_TEST(objc_test_cstring_substring_safe) {
...
FOSSIL_TEST(objc_test_cstring_reverse_safe) {
...
FOSSIL_TEST(objc_test_cstring_contains_safe) {
...
FOSSIL_TEST(objc_test_cstring_repeat_safe) {
    const char *str = "Safe";
    size_t max_len = 20;
...
FOSSIL_TEST(objc_test_cstring_strip_safe) {
    const char *str = "!!!Safe!!!";
    size_t max_len = 20;
...
FOSSIL_TEST(objc_test_cstring_count_safe) {
...
FOSSIL_TEST(objc_test_cstring_pad_left_safe_and_pad_right_safe) {
    const char *str = "Safe";
    size_t max_len = 10;
...
FOSSIL_TEST(objc_test_cstring_starts_with_safe_and_ends_with_safe) {
...
FOSSIL_TEST(objc_test_cstring_equals_safe_and_iequals_safe) {
...
FOSSIL_TEST(objc_test_cstring_icontains_safe) {
    const char *str = "SafeContains";
...
FOSSIL_TEST(objc_test_cstring_strip_quotes_safe) {
    size_t max_len = 20;
...
FOSSIL_TEST(objc_test_cstring_normalize_spaces_safe) {
    size_t max_len = 32;
...
FOSSIL_TEST(objc_test_cstring_index_of_safe) {
...
FOSSIL_TEST(objc_test_cstring_silly_basic) {
...
FOSSIL_TEST(objc_test_cstring_silly_buffer_too_small) {
    char input[] = "Hello";
...
FOSSIL_TEST(objc_test_cstring_piglatin_vowel_start) {
    char input[] = "apple";
    char output[64];
...
FOSSIL_TEST(objc_test_cstring_piglatin_consonant_start) {
    char input[] = "banana";
    char output[64];
    int rc = fossil_io_cstring_piglatin(input, output, sizeof(output));
    ASSUME_ITS_EQUAL_I32(0, rc);
...
FOSSIL_TEST(objc_test_cstring_piglatin_multiple_words) {
...
FOSSIL_TEST(objc_test_cstring_piglatin_buffer_too_small) {
    char input[] = "banana";
    char output[4]; // Too small
    int rc = fossil_io_cstring_piglatin(input, output, sizeof(output));
    ASSUME_ITS_TRUE(rc != 0);
...
FOSSIL_TEST(objc_test_cstring_leetspeak_basic) {
...
FOSSIL_TEST(objc_test_cstring_leetspeak_buffer_too_small) {
    char input[] = "leet";
...
FOSSIL_TEST(objc_test_cstring_mocking_basic) {
...
FOSSIL_TEST(objc_test_cstring_mocking_empty) {
...
FOSSIL_TEST(objc_test_cstring_rot13_basic) {
...
FOSSIL_TEST(objc_test_cstring_rot13_twice_is_original) {
...
FOSSIL_TEST(objc_test_cstring_shuffle_basic) {
    char *input = "abcdef";
...
FOSSIL_TEST(objc_test_cstring_upper_snake_basic) {
...
FOSSIL_TEST(objc_test_cstring_upper_snake_with_symbols) {
    char *result = fossil_io_cstring_upper_snake("Hello, World!");
    ASSUME_NOT_CNULL(result);
...
FOSSIL_TEST(objc_test_cstring_number_from_words) {
    int value = 0;
...
FOSSIL_TEST(objc_test_cstring_number_to_words) {
    char buffer[64];
...
FOSSIL_TEST(objc_test_cstring_string_to_money) {
    double value;
...
FOSSIL_TEST(objc_test_cstring_string_to_money_currency) {
    double value;
...
FOSSIL_TEST_GROUP(objc_string_tests) {
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_create_and_free);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_copy);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_concat);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_length);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_compare);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_trim);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_split);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_replace);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_to_upper);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_to_lower);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_starts_with);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_ends_with);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_substring);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_reverse);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_contains);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_repeat);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_strip);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_count);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_pad_left);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_pad_right);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_icmp);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_icontains);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_format);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_join);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_index_of);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_equals);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_iequals);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_escape_json);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_unescape_json);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_normalize_spaces);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_strip_quotes);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_append);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_silly_basic);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_silly_buffer_too_small);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_piglatin_vowel_start);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_piglatin_consonant_start);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_piglatin_multiple_words);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_piglatin_buffer_too_small);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_leetspeak_basic);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_leetspeak_buffer_too_small);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_mocking_basic);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_mocking_empty);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_rot13_basic);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_rot13_twice_is_original);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_shuffle_basic);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_upper_snake_basic);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_upper_snake_with_symbols);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_number_from_words);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_number_to_words);

    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_create_safe_and_free_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_copy_safe_and_dup_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_concat_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_length_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_compare_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_append_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_trim_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_split_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_replace_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_to_upper_safe_and_to_lower_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_format_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_join_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_escape_json_safe_and_unescape_json_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_substring_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_reverse_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_contains_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_repeat_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_strip_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_count_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_pad_left_safe_and_pad_right_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_starts_with_safe_and_ends_with_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_equals_safe_and_iequals_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_icontains_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_strip_quotes_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_normalize_spaces_safe);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_index_of_safe);
    
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_string_to_money);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_string_to_money_currency);

    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_stream_create_and_free);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_stream_write_and_read);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_stream_multiple_writes);
    FOSSIL_TEST_ADD(objc_string_suite, objc_test_cstring_stream_empty_read);

    FOSSIL_TEST_REGISTER(objc_string_suite);
}
