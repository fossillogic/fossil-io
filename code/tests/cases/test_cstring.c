...
{
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_create_free);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_create_null);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_money_to_string);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_money_to_string_negative);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_string_to_money);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_case_compare);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_case_search);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_case_starts_with);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_case_ends_with);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_case_replace);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_mocking_case);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_rot13_transform);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_leetspeak);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_piglatin);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_shuffle);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_upper_snake);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_length);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_compare);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_concat);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_to_upper);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_to_lower);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_contains);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_starts_with);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_ends_with);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_substring);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_index_of);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_pad_left);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_pad_right);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_cstring_repeat);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_escape_json);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_normalize_spaces);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_strip_quotes);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_number_to_words);
    FOSSIL_ADD_TEST(c_cstring_suite, c_test_number_from_words);

    FOSSIL_ADD_SUITE(c_cstring_suite);
}
