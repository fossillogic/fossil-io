...
static cstring cipher_base64(ccstring text, int decode)
{
    ...
    else
    {
        int b64_index[256] = {0};
        for (int i = 0; i < 64; ++i)
            b64_index[(unsigned char)b64_table[i]] = i;
        ...
        for (i = 0, j = 0; i < len;)
        {
            ...
            {
                sextet_a = b64_index[(unsigned char)text[i++]];
            }
            if (text[i] == '=')
            {
                sextet_b = 0;
            ...
            {
                sextet_b = b64_index[(unsigned char)text[i++]];
            }
            if (text[i] == '=')
            {
                sextet_c = 0;
            ...
            {
                sextet_c = b64_index[(unsigned char)text[i++]];
            }
            if (text[i] == '=')
            {
                sextet_d = 0;
            ...
            {
                sextet_d = b64_index[(unsigned char)text[i++]];
            }
...
static cstring cipher_base32(ccstring text, int decode)
{
    ...
    else
    {
        int b32_index[256] = {0};
        for (int i = 0; i < 32; ++i)
            b32_index[(unsigned char)b32_table[i]] = i;
