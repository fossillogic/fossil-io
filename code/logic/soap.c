...
static const pattern_t technobabble_patterns[] = {
    {"quantum entanglement"}, {"machine learning"}, {"deep neural network"}, {"blockchain"}, {"AI-driven"}, {"cloud computing"}, {"hyperconverged"}, {"cyber-physical"}, {"nanotechnology"}, {"augmented reality"}, {"edge computing"}, {"IoT-enabled"}, {"autonomous system"}, {"next-gen"}, {"distributed ledger"}, {"big data"}, {"artificial intelligence"}, {"neural net"}, {"virtual reality"}, {"smart contract"}, {"tokenization"}, {"decentralized"}, {"cryptocurrency"}, {"internet of things"}, {"5G"}, {"metaverse"}, {"digital twin"}, {"self-driving"}, {"robotics"}, {"bioinformatics"}, {"genomics"}, {"quantum computing"}, {"blockchain technology"}, {"AI-powered"}, {"data lake"}, {"serverless"}, {"microservices"}, {"containerization"}, {"orchestration"}, {"edge AI"}, {"fog computing"}, {"digital transformation"}, {"smart city"}, {"predictive analytics"}, {"prescriptive analytics"}, {"data mining"}, {"data science"}, {"data engineering"}, {"cloud-native"}, {"multi-cloud"}, {"hybrid cloud"}, {"zero trust"}, {"blockchain-enabled"}, {"AI-first"}, {NULL}};

static const pattern_t hype_patterns[] = {
    {"amazing"}, {"incredible"}, {"epic"}, {"unbelievable"}, {"mind-blowing"}, {"groundbreaking"}, {"revolutionary"}, {"next level"}, {"must see"}, {"once in a lifetime"}, {"life changing"}, {"game changer"}, {"exclusive"}, {"jaw dropping"}, {"life altering"}, {"legendary"}, {"phenomenal"}, {"unprecedented"}, {"record-breaking"}, {"world-class"}, {"state-of-the-art"}, {"cutting edge"}, {"breakthrough"}, {"unmatched"}, {"unrivaled"}, {"unparalleled"}, {"best ever"}, {"never before"}, {"must have"}, {"can't miss"}, {"top rated"}, {"blockbuster"}, {"sensational"}, {"spectacular"}, {"mind blowing"}, {"outstanding"}, {"astounding"}, {"stunning"}, {"breathtaking"}, {"extraordinary"}, {"remarkable"}, {"unreal"}, {"fantastic"}, {"superb"}, {"magnificent"}, {"marvelous"}, {NULL}};

static const pattern_t political_patterns[] = {
    {"vote"}, {"policy"}, {"government"}, {"election"}, {"legislation"}, {"reform"}, {"candidate"}, {"campaign"}, {"democracy"}, {"party"}, {"protest"}, {"senate"}, {"congress"}, {"bill"}, {"law"}, {"parliament"}, {"representative"}, {"constituent"}, {"lobby"}, {"politician"}, {"political"}, {"governor"}, {"mayor"}, {"president"}, {"prime minister"}, {"cabinet"}, {"minister"}, {"secretary"}, {"referendum"}, {"ballot"}, {"poll"}, {"platform"}, {"manifesto"}, {"coalition"}, {"majority"}, {"minority"}, {"opposition"}, {"incumbent"}, {"constituency"}, {"district"}, {"jurisdiction"}, {"executive"}, {"judiciary"}, {"legislature"}, {"bureaucracy"}, {"regulation"}, {"statute"}, {"ordinance"}, {"decree"}, {"mandate"}, {"impeachment"}, {NULL}};

static const pattern_t offensive_patterns[] = {
    {"idiot"}, {"stupid"}, {"dumb"}, {"fool"}, {"loser"}, {"moron"}, {"hate"}, {"jerk"}, {"trash"}, {"scum"}, {"nonsense"}, {"pathetic"}, {"worthless"}, {"disgusting"}, {"ignorant"}, {"cretin"}, {"imbecile"}, {"retard"}, {"sucks"}, {"garbage"}, {"ugly"}, {"fat"}, {"gross"}, {"stinks"}, {"douche"}, {"bastard"}, {"asshole"}, {"prick"}, {"bitch"}, {"slut"}, {"whore"}, {"dick"}, {"piss off"}, {"shut up"}, {"kill yourself"}, {"kys"}, {"die"}, {"go to hell"}, {"freak"}, {"weirdo"}, {"psycho"}, {"lunatic"}, {"nutcase"}, {"twat"}, {"cunt"}, {"fuck"}, {"shit"}, {"bullshit"}, {"crap"}, {NULL}};

static const pattern_t misinformation_patterns[] = {
    {"fake news"}, {"hoax"}, {"false"}, {"misleading"}, {"rumor"}, {"conspiracy"}, {"unverified"}, {"scam"}, {"fraud"}, {"deceptive"}, {"disinformation"}, {"fabricated"}, {"untrue"}, {"debunked"}, {"myth"}, {"urban legend"}, {"clickbait"}, {"sensationalized"}, {"out of context"}, {"doctored"}, {"forged"}, {"faked"}, {"manipulated"}, {"deepfake"}, {"false claim"}, {"false narrative"}, {"false report"}, {"false story"}, {"false information"}, {"false statement"}, {"falsehood"}, {"misreport"}, {"misquote"}, {"misattribute"}, {"misrepresent"}, {"misstate"}, {"misinform"}, {"mislead"}, {"misinterpret"}, {"misconstrue"}, {"miscommunicate"}, {NULL}};

static const pattern_t conspiracy_patterns[] = {
    {"hidden agenda"}, {"secret plan"}, {"shadow government"}, {"cover-up"}, {"inside job"}, {"elite"}, {"controlled opposition"}, {"false flag"}, {"government plot"}, {"manipulation"}, {"deep state"}, {"puppet master"}, {"new world order"}, {"illuminati"}, {"mind control"}, {"chemtrails"}, {"aliens"}, {"ufo"}, {"area 51"}, {"moon landing hoax"}, {"flat earth"}, {"reptilian"}, {"secret society"}, {"big pharma"}, {"big tech"}, {"big oil"}, {"big brother"}, {"mass surveillance"}, {"plandemic"}, {"crisis actor"}, {"hoax"}, {"cover up"}, {"deep cover"}, {"psyop"}, {"psy ops"}, {"psy-ops"}, {"psy ops operation"}, {"psy-ops operation"}, {"psy ops campaign"}, {"psy-ops campaign"}, {"psy ops program"}, {"psy-ops program"}, {NULL}};

static const pattern_t formal_patterns[] = {
    {"therefore"}, {"moreover"}, {"hence"}, {"thus"}, {"accordingly"}, {"in conclusion"}, {"furthermore"}, {"consequently"}, {"as a result"}, {"in addition"}, {"notwithstanding"}, {"nevertheless"}, {"nonetheless"}, {"whereas"}, {"hereby"}, {"herein"}, {"herewith"}, {"heretofore"}, {"therein"}, {"therewith"}, {"thereafter"}, {"thereupon"}, {"thereby"}, {"wherein"}, {"whereof"}, {"whereupon"}, {"whereby"}, {"pursuant to"}, {"in accordance with"}, {"insofar as"}, {"inasmuch as"}, {"in the event that"}, {"in the absence of"}, {"in the presence of"}, {"in the course of"}, {"in the context of"}, {"in the light of"}, {"in the interest of"}, {"in the process of"}, {"in the case of"}, {"in the matter of"}, {"in the opinion of"}, {NULL}};

static const pattern_t casual_patterns[] = {
    {"hey"}, {"lol"}, {"omg"}, {"btw"}, {"idk"}, {"yep"}, {"nah"}, {"cool"}, {"awesome"}, {"what's up"}, {"sup"}, {"yo"}, {"dude"}, {"bro"}, {"fam"}, {"bruh"}, {"lmao"}, {"rofl"}, {"haha"}, {"hehe"}, {"xd"}, {"ikr"}, {"tbh"}, {"fyi"}, {"imo"}, {"imho"}, {"smh"}, {"fml"}, {"ily"}, {"nope"}, {"yolo"}, {"meh"}, {"ugh"}, {"yay"}, {"yesss"}, {"noooo"}, {"yaaaas"}, {"bruh moment"}, {"oh no"}, {"omfg"}, {"wtf"}, {"wtfv"}, {"lmaoed"}, {"lmaoing"}, {"haha lol"}, {"lol haha"}, {"xd lol"}, {"lol xd"}, {"fml lol"}, {"smdh"}, {"sksksk"}, {"and i oop"}, {"yeet"}, {"yeeted"}, {"yeeting"}, {"uwu"}, {"owo"}, {"rawr"}, {"rawr x3"}, {NULL}};

static const pattern_t sarcasm_patterns[] = {
    {"yeah right"}, {"as if"}, {"sure"}, {"oh great"}, {"fantastic"}, {"brilliant"}, {"wow"}, {"amazing"}, {"just perfect"}, {"totally"}, {"obviously"}, {"of course"}, {"nice job"}, {"good luck with that"}, {"what a surprise"}, {"how original"}, {"so helpful"}, {"thanks a lot"}, {"just what I needed"}, {"couldn't be better"}, {"love it"}, {"can't wait"}, {"so excited"}, {"best ever"}, {"what a genius"}, {"so smart"}, {"how clever"}, {"so funny"}, {"hilarious"}, {"great idea"}, {NULL}};

static const pattern_t neutral_patterns[] = {
    {"okay"}, {"alright"}, {"yes"}, {"no"}, {"maybe"}, {"fine"}, {"good"}, {"bad"}, {"average"}, {"normal"}, {"regular"}, {"standard"}, {"typical"}, {"usual"}, {"ordinary"}, {"so-so"}, {"meh"}, {"not bad"}, {"not good"}, {"could be better"}, {"could be worse"}, {"nothing special"}, {"not sure"}, {"not certain"}, {"uncertain"}, {"possibly"}, {"perhaps"}, {"potentially"}, {"likely"}, {"unlikely"}, {"neutral"}, {"indifferent"}, {"unbiased"}, {"impartial"}, {NULL}};

static const pattern_t aggressive_patterns[] = {
    {"attack"}, {"destroy"}, {"fight"}, {"kill"}, {"smash"}, {"crush"}, {"annihilate"}, {"rage"}, {"strike"}, {"obliterate"}, {"dominate"}, {"conquer"}, {"invade"}, {"overpower"}, {"subdue"}, {"eliminate"}, {"eradicate"}, {"wipe out"}, {"take down"}, {"beat"}, {"defeat"}, {"punish"}, {"hurt"}, {"harm"}, {"maul"}, {"batter"}, {"brawl"}, {"clash"}, {"assault"}, {"barrage"}, {"bombard"}, {"ambush"}, {"charge"}, {"storm"}, {"bust"}, {"wreck"}, {"wreck havoc"}, {"tear apart"}, {"rip apart"}, {"rip to shreds"}, {NULL}};

static const pattern_t emotional_patterns[] = {
    {"happy"}, {"sad"}, {"angry"}, {"excited"}, {"fear"}, {"joy"}, {"love"}, {"hate"}, {"surprised"}, {"ecstatic"}, {"depressed"}, {"anxious"}, {"nervous"}, {"thrilled"}, {"delighted"}, {"miserable"}, {"furious"}, {"elated"}, {"content"}, {"disappointed"}, {"frustrated"}, {"overjoyed"}, {"heartbroken"}, {"grateful"}, {"resentful"}, {"jealous"}, {"envious"}, {"ashamed"}, {"proud"}, {"guilty"}, {"hopeful"}, {"hopeless"}, {"relieved"}, {"stressed"}, {"calm"}, {"peaceful"}, {"confused"}, {"bored"}, {"lonely"}, {"scared"}, {NULL}};

static const pattern_t passive_patterns[] = {
    {"sure"}, {"whatever"}, {"fine"}, {"if you say so"}, {"okay then"}, {"no problem"}, {"as you wish"}, {"right"}, {"yeah, sure"}, {"if that's what you want"}, {"I guess"}, {"if you insist"}, {"not my problem"}, {"do what you want"}, {"go ahead"}, {"be my guest"}, {"I don't care"}, {"it's up to you"}, {"suit yourself"}, {"have it your way"}, {"whatever you say"}, {"if it makes you happy"}, {"I'm fine"}, {"I'm okay"}, {"I'm good"}, {"it's fine"}, {"it's okay"}, {"it's whatever"}, {"that's fine"}, {"that's okay"}, {"that's whatever"}, {NULL}};

static const pattern_t snowflake_patterns[] = {
    {"triggered"}, {"microaggression"}, {"safe space"}, {"privilege"}, {"problematic"}, {"offended"}, {"snowflake"}, {"fragile"}, {"woke"}, {"cancel culture"}, {"toxic"}, {"gaslighting"}, {"trauma"}, {"oppressed"}, {"victim"}, {"identity politics"}, {"intersectional"}, {"systemic"}, {"inclusion"}, {"diversity"}, {"equity"}, {"ally"}, {"marginalized"}, {"lived experience"}, {"call out"}, {"callout"}, {"safe zone"}, {"emotional labor"}, {"tone policing"}, {"cultural appropriation"}, {"trigger warning"}, {"unpack"}, {"problematic fave"}, {"problematic favorite"}, {"privileged"}, {"decolonize"}, {"inclusivity"}, {"oppression"}, {"systemic bias"}, {"implicit bias"}, {"white fragility"}, {"white privilege"}, {"check your privilege"}, {"lived experiences"}, {"identity"}, {"safe environment"}, {"emotional support"}, {"emotional damage"}, {"emotional distress"}, {"emotional safety"}, {"emotional wellbeing"}, {"emotional well-being"}, {"emotional health"}, {"emotional needs"}, {"emotional response"}, {"emotional trauma"}, {"emotional abuse"}, {"emotional burden"}, {"emotional exhaustion"}, {"emotional intelligence"}, {"emotional resilience"}, {"emotional sensitivity"}, {"emotional support animal"}, {"emotional trigger"}, {"emotional vulnerability"}, {NULL}};
...
fossil_io_soap_grammar_style_t fossil_io_soap_analyze_grammar_style(const char *text)
{
    ...
    if (words)
        r.passive_voice_pct = (passive * 100) / words;
    ...
    if (strstr(text, "therefore") || strstr(text, "however") || strstr(text, "thus"))
        has_formal = 1;
    if (strstr(text, "lol") || strstr(text, "btw") || strstr(text, "hey"))
        has_casual = 1;
...
char *fossil_io_soap_correct_grammar(const char *text)
{
    ...
    while (*p)
    {
        ...
        if (!in_quote && !in_url && is_word_char(c) && isalpha((unsigned char)c))
        {
                 ...
                 strncmp(p, "neednt", 6) == 0 || strncmp(p, "darent", 6) == 0))
            {
                ...
                size_t wlen = 0;
                while (is_word_char(p[wlen]) && isalpha((unsigned char)p[wlen]))
                    wlen++;
                if (wlen > 3 && wlen < 10)
                {
    ...
    *q = '\0';
    ...
    while (q > out && isspace((unsigned char)q[-1]))
        *(--q) = 0;
...
fossil_io_soap_scores_t fossil_io_soap_score(const char *text)
{
    ...
    if (punct_count > (int)(len / 6))
        s.clarity -= 10;

    /* ----------------------------
     * WORD ANALYSIS (SINGLE PASS)
     * ---------------------------- */
    ...
    if (words)
    {
        ...
        for (int i = 0; words[i]; i++)
        {
            ...
            if (prev_word && strcasecmp(prev_word, w) == 0)
                repeated++;
    ...
    if (allcaps > 0 && allcaps * 3 > wordcount)
        s.quality -= 10;

    /* ----------------------------
     * QUALITY SIGNALS (INLINE)
     * ---------------------------- */
    int exclam = 0;
    ...
    /* spam pattern scan (single pass) */
    for (size_t i = 0; i + 7 < len; i++)
    {
        if (match_word_pattern(text, i, "buy now") ||
            match_word_pattern(text, i, "click here"))
        {
            s.quality -= 10;
            break;
        }
...
static int detect_redundant(char **sentences)
{
    ...
    for (size_t i = 0; sentences[i]; i++)
    {
        ...
        char *start_i = si;
        while (*start_i && (isspace((unsigned char)*start_i) || ispunct((unsigned char)*start_i)))
            start_i++;
        char *end_i = start_i + strlen(start_i);
        while (end_i > start_i && (isspace((unsigned char)*(end_i - 1)) || ispunct((unsigned char)*(end_i - 1))))
            *(--end_i) = 0;
        ...
        for (size_t j = i + 1; sentences[j]; j++)
        {
            ...
            strtolower(sj);
            char *start_j = sj;
            while (*start_j && (isspace((unsigned char)*start_j) || ispunct((unsigned char)*start_j)))
                start_j++;
            char *end_j = start_j + strlen(start_j);
            while (end_j > start_j && (isspace((unsigned char)*(end_j - 1)) || ispunct((unsigned char)*(end_j - 1))))
                *(--end_j) = 0;
...
static int detect_repeated_words(char **words)
{
    ...
    for (size_t i = 0; words[i]; i++)
    {
        ...
        for (size_t j = i + 1; words[j]; j++)
        {
            ...
            for (const char *p = wi; *p; p++)
                if (isalnum((unsigned char)*p))
                {
                    only_punct_i = 0;
                    break;
                }
            for (const char *p = wj; *p; p++)
                if (isalnum((unsigned char)*p))
                {
                    only_punct_j = 0;
                    break;
                }
            if (only_punct_i || only_punct_j)
                continue;
            if (strcasecmp(wi, wj) == 0)
                return 1;
        }
    }
    return 0;
...
static int detect_poor_cohesion(char **sentences)
{
    ...
    if (total > 2)
    {
        ...
        for (size_t i = 1; sentences[i]; i++)
        {
            ...
            if (w1 && w2 && strcasecmp(w1, w2) == 0)
                rep++;
            free(first1);
            free(first2);
        }
        if (((double)rep / (total - 1)) > 0.4)
            weak++;
    }
    ...
    if (total > 0 && ((double)short_count / total) > 0.5)
        weak++;
    if (total > 0 && ((double)long_count / total) > 0.3)
        weak++;
...
static int match_brain_rot(const char *word)
{
    ...
    {
        if (strstr(word, brain_rot_patterns[i].pattern))
            return 1;
    }
    return 0;
}
...
int fossil_io_soap_detect(const char *text, const char *detector_id)
{
    ...
    /* ----------------------------------------
     * GLOBAL NORMALIZATION (ONE TIME ONLY)
     * ---------------------------------------- */
    ...
    /* ----------------------------------------
     * SPLIT ONCE (REUSED BELOW)
     * ---------------------------------------- */
    char **sentences = fossil_io_soap_split(text);
    char **words = fossil_io_soap_split(text);

    /* ----------------------------------------
     * 2. SENTENCE-LEVEL SCAN
     * ---------------------------------------- */
    if (!result && sentences)
    {
        for (size_t i = 0; sentences[i] && !result; i++)
        {
    ...
    if (!result && words)
    {
        int is_brain_rot = (strcmp(detector_id, "brain_rot") == 0);

        for (size_t i = 0; words[i] && !result; i++)
        {
    ...
    /* ----------------------------------------
     * 4. STRUCTURAL DETECTION (ONCE ONLY)
     * ---------------------------------------- */
    if (!result && sentences && words)
    {
...
char **fossil_io_soap_split(const char *text)
{
    ...
    int has_sentence_punct = 0;

    for (const char *q = text; *q; q++)
    {
        if (is_sentence_punct(*q))
        {
            has_sentence_punct = 1;
            break;
        }
    }
...
char *fossil_io_soap_reflow(const char *text, int width)
{
    ...
    /*
     * Index of last space in output buffer
     */
     ...
     */
    while (oi > 0 &&
           isspace((unsigned char)out[oi - 1]))
    {
        oi--;
    }
...
char *fossil_io_soap_capitalize(const char *text, int mode)
{
    ...
    if (mode == 0)
    {
        ...
        for (char *p = s; *p; p++)
        {
            ...
            /*
             * Paragraph/newline capitalization
             */
            if (c == '\n')
            {
                capitalize = 1;
...
char *fossil_io_soap_suggest(const char *text)
{
    ...
    /*
     * Light cleanup only.
     * Do NOT destroy casing or punctuation.
     */
    char *clean = fossil_io_soap_declutter(text);
    if (!clean)
        return NULL;
     ...
     */
    char *corrected = fossil_io_soap_correct_grammar(clean);
    free(clean);
...
char *fossil_io_soap_summarize(const char *text)
{
    ...
    /*
     * Count valid sentences and total output size
     */
    ...
    for (size_t i = 0; sentences[i]; i++)
    {
        ...
        for (const char *p = sentences[i]; *p; p++)
        {
            if (is_word_char(*p))
            {
                has_word = 1;
        ...
        {
            valid_count++;
            total_len += strlen(sentences[i]) + 4;
        }
    }
    ...
    for (size_t i = 0; sentences[i] && added < 2; i++)
    {
        int has_word = 0;
        ...
        memcpy(out + used, sentences[i], slen);
        used += slen;

        if (slen == 0 ||
            !is_sentence_punct(sentences[i][slen - 1]))
        {
            out[used++] = '.';
        }
     ...
     */
    while (used > 0 &&
           isspace((unsigned char)out[used - 1]))
    {
        out[--used] = '\0';
    }
...
char *fossil_io_soap_rewrite(const char *text)
{
    ...
    char *stage1 = fossil_io_soap_declutter(text);
    if (!stage1)
        return NULL;

    char *stage2 = fossil_io_soap_correct_grammar(stage1);
    free(stage1);

    if (!stage2)
        return NULL;

    size_t len = strlen(stage2);

    /*
     * punctuation normalization may expand text:
     * "...!!!" -> ". !"
     * allocate safer headroom
     */
    size_t cap = (len * 2) + 32;

    char *stage3 = malloc(cap);
    if (!stage3)
    {
        free(stage2);
        return NULL;
    ...
    normalize_punctuation(stage2, stage3);
    free(stage2);

    /*
     * final sentence cleanup/capitalization
     */
    finalize_sentences(stage3);

    /*
     * formatting should ONLY handle layout
     */
    char *final = fossil_io_soap_reflow(stage3, 80);
...
char *fossil_io_soap_format(const char *text)
{
    ...
    /* sanitize only dangerous/control chars */
    char *clean = fossil_io_soap_declutter(text);
    if (!clean)
        return NULL;
...
char *fossil_io_soap_declutter(const char *text)
{
    ...
    while (*p)
    {
        ...
        if (prev)
        {
             ...
             * version2
             */
            else if (isalpha((unsigned char)prev) &&
             ...
             * 2Update
             */
            else if (isdigit((unsigned char)prev) &&
             ...
             * XMLParser
             *
             * split before trailing lowercase transition
             */
            else if (isupper((unsigned char)prev) &&
                     isupper((unsigned char)c) &&
                     islower((unsigned char)p[1]))
            {
                split = 1;
            }
